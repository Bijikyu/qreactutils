 ...
 * scenarios.
 * This design favors per-query configurability over a one-size-fits-all
 * solution. It does mean callers must know whether data is optional but keeps
 * query logic explicit.
 *
