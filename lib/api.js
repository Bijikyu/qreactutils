...
const { QueryClient } = require("@tanstack/react-query"); // React Query core client for caching
const axios = require("axios"); // chosen for robust interceptors and promise support
...
const queryClient = new QueryClient({ // one client keeps cache consistent across hooks
  defaultOptions: {
    queries: {
