...
const { safeStringify } = require('./validation.js'); // use safe-stringify to avoid errors when logging circular data
 ...
 */
async function executeAsyncWithLogging(operation, operationName, errorHandler) { // wrap async ops so all use same logging pattern
