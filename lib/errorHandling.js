 ...
 */
async function executeWithErrorHandling(fn, functionName, errorTransform) { // generic async wrapper so modules stay DRY
 ...
 * @returns {*} Function result or throws transformed error
 */
function executeSyncWithErrorHandling(fn, functionName, errorTransform) { // sync variant avoids async overhead when not needed
