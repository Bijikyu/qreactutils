 ...
 */
function isFunction(value) { // tiny guard to keep callback validation consistent
 ...
 */
function isObject(value) { // helper ensures we don't treat arrays or null as objects
 ...
 */
function isAxiosErrorWithStatus(error, status) { // small helper to detect specific HTTP failures
