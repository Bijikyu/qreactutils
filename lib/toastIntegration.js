 ...
 */
async function executeWithErrorToast(operation, toast, errorTitle = 'Error') {
  try {
 ...
 * @returns {*} Operation result or throws error
 */
async function executeWithToastFeedback(operation, toast, successMessage, errorTitle = 'Error') {
  try {
