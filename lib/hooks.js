...
*/
const TOAST_LIMIT = 1; // only show one toast at a time to reduce clutter and keep focus on latest
...
*/
const TOAST_REMOVE_DELAY = 1000000; // delay before toast cleanup; long value aids testing and demo scenarios
